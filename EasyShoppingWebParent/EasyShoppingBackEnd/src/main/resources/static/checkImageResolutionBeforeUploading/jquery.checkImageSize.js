 ...
 */
 (function($) {
    $.fn.checkImageSize = function(index) {

        if (!this.length) { return this; }

        var opts = $.extend(true, {}, $.fn.checkImageSize.defaults, options);
		const inp = document.getElementById('nameExtraImage' + index);
		//var opts = $.fn.checkImageSize.defaults;
		            ...
		            img.onload = function () {
		                ...
		                if (imgWidth > maxWidth || imgHeight > maxHeight) {
		                    ...
		                    if (opts.showError) {
								...
								inp.setCustomValidity("You must choose an image " + maxHeight + "x" + maxWidth + "(px) max");
								inp.reportValidity();
		                    }
		                }
    ...
    $.fn.checkImageSize.defaults = {
        minWidth: 0,		// Numeric; Pixel value
        minHeight: 0,		// Numeric; Pixel value
        maxWidth: 700,		// Numeric; Pixel value
        maxHeight: 700,	// Numeric; Pixel value
