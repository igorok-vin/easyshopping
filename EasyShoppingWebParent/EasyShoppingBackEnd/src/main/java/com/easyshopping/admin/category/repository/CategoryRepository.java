package com.easyshopping.admin.category.repository;
...
public interface CategoryRepository extends PagingAndSortingRepository<Category,Integer> {
    ...
    @Query("UPDATE Category u SET u.enabled = ?2 WHERE u.name = ?1")
    @Modifying
    public void updateEnabledStatus(String name, boolean enabled);
